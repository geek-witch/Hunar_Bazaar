      ...
      <header ref={headerRef} className="bg-brand-teal sticky top-0 z-50 shadow-md relative">
        <nav className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); handleNavigate(Page.AboutUs); }} className="text-gray-200 hover:text-white transition-colors">About Us</a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleNavigate(Page.Contact); }} className="text-gray-200 hover:text-white transition-colors">Contact</a>
          ...
          <div className={`lg:hidden flex items-center ${isMobileSearchOpen && currentPage === Page.Home ? 'w-full' : ''}`}>
            {isMobileSearchOpen && currentPage === Page.Home ? (
              <div className="w-full flex items-center">
                ...
                <button onClick={() => setIsMobileSearchOpen(false)} className="text-white ml-2" aria-label="Close search">
