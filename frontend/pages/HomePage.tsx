...
const HomePage: React.FC<{ navigation: Navigation }> = ({ navigation }) => {
    ...
    const suggestedUsers = [
        { name: 'Jane Doe', skill: 'Teaches: JS, React', img: '/asset/p1.jfif' },
        { name: 'John Smith', skill: 'Teaches: C++, Python', img: '/asset/p2.png' },
        { name: 'Emily White', skill: 'Teaches: UI/UX, Figma', img: '/asset/p3.jpg' },
        { name: 'Michael Brown', skill: 'Teaches: SQL, Databases', img: '/asset/p4.jpg' },
    ];
        ...
        <div className="relative bg-gradient-to-r from-brand-teal via-brand-teal-dark to-brand-teal bg-[length:200%_200%] animate-bg-wave text-white p-8 md:p-12 rounded-2xl shadow-lg mb-12 overflow-hidden flex flex-col md:flex-row items-center">
          <div className="md:w-2/3 z-10 text-center md:text-left">
            ...
            <p className="text-lg text-gray-200 mt-4 max-w-xl mx-auto md:mx-0">
              Ready to learn something new or share your expertise? Explore skills, connect with tutors, and start your
              journey today.
            </p>
          </div>
...
=======
        ...
        <div className="relative bg-gradient-to-r from-brand-teal via-brand-teal-dark to-brand-teal bg-[length:200%_200%] animate-bg-wave text-white p-8 md:p-12 rounded-2xl shadow-lg mb-12 overflow-hidden flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 z-10 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold">Welcome to Hunar Bazaar!</h1>
              <p className="text-lg text-gray-200 mt-4 max-w-xl mx-auto md:mx-0">Ready to learn something new or share your expertise? Explore skills, connect with tutors, and start your journey today.</p>
            </div>
            <div className="md:w-1/3 mt-8 md:mt-0 flex justify-center z-10">
                <img src="/asset/1.gif" alt="Learning Illustration" className="rounded-lg shadow-xl" />
            </div>
>>>>>>> 30995dc10da19b58cfd601984b908c105e8613f0
        ...
        {/* Popular Skills Section with new icons */}
...
=======
            {popularSkills.map(skill => {
              const Icon = skill.icon;
              return (
                  <div key={skill.name} className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm text-center hover:shadow-xl hover:-translate-y-2 transition-all cursor-pointer flex flex-col items-center justify-center">
                    <div className={`w-16 h-16 rounded-2xl mb-4 flex items-center justify-center ${skill.bgColor}`}>
                        <Icon className={`w-8 h-8 ${skill.textColor}`} />
                    </div>
                    <h3 className="font-semibold text-gray-800 text-sm sm:text-base">{skill.name}</h3>
...
>>>>>>> 30995dc10da19b58cfd601984b908c105e8613f0
        ...
        {/* Changed title to "Suggestions For You" */}
        <section className="mb-12">
...
=======
            {suggestedUsers.map(user => (
              <div key={user.name} className="bg-white p-6 rounded-xl shadow-sm text-center hover:shadow-lg transition-shadow">
                <img src={user.img} alt={user.name} className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-white ring-2 ring-brand-teal/20" />
                <h3 className="text-lg font-semibold text-brand-teal">{user.name}</h3>
                <p className="text-gray-500 text-sm">{user.skill}</p>
                <button className="mt-4 bg-brand-teal/10 text-brand-teal px-4 py-1.5 rounded-full text-sm font-medium hover:bg-brand-teal/20">View Profile</button>
>>>>>>> 30995dc10da19b58cfd601984b908c105e8613f0
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-y-12 md:gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 flex flex-col hover:border-brand-teal transition-all">
              ...
              <ul className="mt-6 space-y-3 text-gray-600 flex-grow">
                ...
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Basic profile customization and
                  Mangement
                </li>
              </ul>
        ...
        <section>
            ...
            <div className="grid md:grid-cols-3 gap-y-12 md:gap-8 max-w-7xl mx-auto">
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 flex flex-col hover:border-brand-teal transition-all">
                    ...
                    <p className="mt-4 text-4xl font-bold text-gray-800">Free</p>
                    <ul className="mt-6 space-y-3 text-gray-600 flex-grow">
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> skill exchange for free</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Access the basic features</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Basic profile customization and Mangement</li>
                    </ul>
                    <button className="mt-8 w-full bg-brand-teal/10 text-brand-teal py-3 rounded-lg font-semibold hover:bg-brand-teal/20 transition-colors">
                        Your Current Plan
                    </button>
                ...
                {/* Premium Plan - Highlighted */}
                <div className="bg-brand-teal text-white p-8 rounded-xl shadow-2xl flex flex-col ring-4 ring-white md:transform md:scale-105 relative">
                     <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-white text-brand-teal text-xs font-bold uppercase px-3 py-1 rounded-full shadow-md">Most Popular</div>
                    <h3 className="text-2xl font-bold">Premium</h3>
                    <p className="mt-2 text-gray-300">For dedicated learners & teachers</p>
                    <p className="mt-4 text-4xl font-bold">$10<span className="text-lg font-normal text-gray-300">/month</span></p>
                    <ul className="mt-6 space-y-3 flex-grow">
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-white mr-2 shrink-0" /> Unlimited skill exchanges</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-white mr-2 shrink-0" /> Advanced profile analytics</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-white mr-2 shrink-0" /> AI support</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-white mr-2 shrink-0" /> Reminders Option</li>
                    </ul>
                    <button className="mt-8 w-full bg-white text-brand-teal py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors">
                        Upgrade to Premium
                    </button>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 flex flex-col hover:border-brand-teal transition-all">
                    <h3 className="text-2xl font-bold text-brand-teal">Professional</h3>
                    <p className="mt-2 text-gray-500">For power users & companies</p>
                    <p className="mt-4 text-4xl font-bold text-gray-800">$25<span className="text-lg font-normal text-gray-500">/month</span></p>
                    <ul className="mt-6 space-y-3 text-gray-600 flex-grow">
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Everything in Premium</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Access for all Employees </li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Access to exclusive workshops</li>
                        <li className="flex items-center"><CheckCircleIcon className="w-5 h-5 text-green-500 mr-2 shrink-0" /> Customized AI features</li>
                    </ul>
                    <button className="mt-8 w-full bg-brand-teal text-white py-3 rounded-lg font-semibold hover:bg-brand-teal-dark transition-colors">
                        Upgrade to Professional
                    </button>
                </div>
            </div>
