...
import { BadgeIcon } from "../components/icons/AccountIcons";
import { HandshakeIcon } from "lucide-react";
import heroGif from "../asset/aboutus.gif";
import heroGifAlt from "../asset/aboutus1.gif";
        ...
        >
            ...
            <section className="relative text-white bg-gradient-to-r from-brand-teal via-brand-teal-dark to-brand-teal">
                ...
                <div
                    ...
                    style={{ backgroundImage: `url(${heroGifAlt})` }}
                />
                ...
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 h-[70vh] md:h-[80vh] flex items-center justify-center relative z-10">
                    <div className="text-center max-w-3xl">
                        ...
                        <p className="mt-6 text-lg text-gray-200 mx-auto max-w-2xl">
                            Hunar Bazaar is a simple and fair skill-exchange platform where 
                            you can share your skills and learn new ones without money.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                To democratize learning by enabling every individual to teach 
                                what they know and learn what they need—without financial barriers.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-700 leading-relaxed">
                                To create the world's largest skill-exchange ecosystem where 
                                everyone becomes both a learner and a teacher.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Earn credits by teaching your skills and use them to learn new skills.",
                            },
                            {
                                Icon: BookOpenIcon,
                                title: "Interactive Learning",
                                desc: "Learn directly from people with real experience, through hands on and practical sessions.",
                            },
                            {
                                Icon: ZapIcon,
                                title: "AI-Powered Matching",
                                desc: "Smart AI matches you with the best person based on your interests, and skills.",
                            },
                            {
                                Icon: BadgeIcon,
                                title: "Certificates",
                                desc: "Receive digital certificates after completing your learning sessions to showcase your skills.",
                            },
                            {
                                Icon: GlobeIcon,
                                title: "Global Community",
                                desc: "Meet learners and experts from across Pakistan and the world to exchange unique skills.",
                            },
                            {
                                Icon: CheckCircleIcon,
                                title: "Safe & Secure",
                                desc: "Verified profiles, and a secure system ensure a trusted learning environment.",
                            },
                        ].map((item, index) => (
                            <motion.div
                                key={index}
            ...
            <section className="py-16 sm:py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto" variants={stagger}>
                        {[
            ...
            <section className="py-16 sm:py-20 bg-brand-teal text-white relative">
                ...
                <motion.div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10" variants={stagger}>
                    <motion.div className="text-center mb-12" variants={fadeUp}>
                        <h2 className="text-3xl font-bold">Our Core Values</h2>
                        <div className="w-24 h-1 bg-white mx-auto mt-2"></div>
                    </motion.div>

                    <motion.div className="grid md:grid-cols-4 gap-8 text-center" variants={stagger}>
                        {[
                            {
                                Icon: HandshakeIcon,
                                title: "Collaboration",
                                desc: "We believe learning grows when people come together and share what they know.",
                            },
                            {
                                Icon: ZapIcon,
                                title: "Innovation",
                                desc: "We aim to bring modern, smart, and impactful ways of learning to everyone.",
                            },
                            {
                                Icon: StarIcon,
                                title: "Excellence",
                                desc: "We strive to deliver high-quality learning experiences for all users.",
                            },
                            {
                                Icon: PlusCircleIcon,
                                title: "Inclusivity",
                                desc: "Everyone is welcome — every skill matters, and every learner deserves a chance.",
                            },
                        ].map((v, i) => (
                            <motion.div key={i} variants={fadeUp} whileHover={{ scale: 1.1 }}>
                                <div className="mx-auto text-4xl mb-4 text-white">
                                    <v.Icon className="w-10 h-10 mx-auto" />
                                </div>
            ...
            <section className="py-16 sm:py-20 bg-brand-light-blue text-center">
                <motion.div className="container mx-auto px-4 sm:px-6 lg:px-8" variants={fadeUp}>
