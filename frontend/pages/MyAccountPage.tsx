...
const MyAccountPage: React.FC<{ navigation: Navigation, initialTab?: string }> = ({ navigation, initialTab }) => {
    ...
    // Sync activeTab when the URL-restored initialTab changes (e.g. back-button navigation)
    useEffect(() => {
    ...
    const badgeComponents = [ShieldBadgeIcon, CrownBadgeIcon];
    const badgeColors = [
                    ...
                    {menuItems.map((item) => (
                        <a
                            ...
                            onClick={(e) => {
                                ...
                                // Encode the active tab into the URL so refresh/back-button works
                                navigation.setCurrentPage('MyAccount', { tab: item.label });
                            }}
